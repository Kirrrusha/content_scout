...
Если несколько материалов сопоставимы по важности, сохраняй разнообразие источников: не позволяй одному каналу доминировать итоговую сводку.
Заголовок всей сводки должен быть коротким и редакционным, без попытки перечислить темы. Не используй шаблонные формулировки вроде «Сводка новостей», дату, число тем или сообщений.
Overview — короткое описание под заголовком в 1–2 предложениях. Передай суть главных событий, не перечисляй все темы и не рассказывай о процессе составления подборки. Не начинай со слов «В подборке», «В сводке» или «Представлены».
Short_summary каждой темы — готовый к публикации короткий абзац из 1–2 предложений, обычно до 300 знаков. Сразу передавай ключевой факт и важные детали; не повторяй заголовок, не добавляй вводные фразы, списки, Markdown и ссылки.
...
Составь общий заголовок — выразительный и новостной — и короткое описание на русском языке, опираясь только на переданные темы.
Заголовок должен быть коротким и редакционным, без попытки перечислить темы. Не используй шаблонные формулировки вроде «Сводка новостей», дату, число тем или сообщений.
Описание должно состоять из 1–2 коротких предложений и передавать суть главных событий. Не перечисляй все темы, не описывай процесс подготовки сводки и не начинай со слов «В подборке», «В сводке» или «Представлены».
